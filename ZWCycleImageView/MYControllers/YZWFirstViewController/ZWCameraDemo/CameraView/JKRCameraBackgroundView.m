...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    _playButton = [[UIButton alloc] initWithFrame:CGRectMake((SCREEN_WIDTH - 75) / 2, SCREEN_HEIGHT - 80, 75, 75)];
    ...
    _progressView = [[JKRCameraProgressView alloc] initWithFrame:CGRectMake(0, SCREEN_HEIGHT - 6, frame.size.width, 6)];
