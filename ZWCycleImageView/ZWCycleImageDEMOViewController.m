//
//  ZWCycleImageDEMOViewController.m
//  ZWCycleImageView
//
...
#import "ZWCycleImageDEMOViewController.h"
#import "ZWCycleImageView.h"

@interface ZWCycleImageDEMOViewController ()<ZWCycleImageViewDelegate>

@end

@implementation ZWCycleImageDEMOViewController
...
- (void)viewDidLoad {
    ...
    // 本地加载 --- 创建不带标题的图片轮播器
    ZWCycleImageView *zwCycleImageView = [ZWCycleImageView ZWCycleImageViewWithFrame:CGRectMake(0, 80, w, 180) shouldInfiniteLoop:YES imageNamesGroup:imageNames];
    ...
    //         --- 轮播时间间隔，默认1.0秒，可自定义
//    zwCycleImageView.autoScrollTimeInterval = 4.0;
